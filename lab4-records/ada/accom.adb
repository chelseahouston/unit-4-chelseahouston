...
procedure Accom is
    ...
    type AccommodationVariant is (ACCKIND_FLAT, ACCKIND_HOUSE);
    type Accommodation (accom_variant : AccommodationVariant) is
        record
    ...
    begin
        case accom.accom_variant is
            when ACCKIND_HOUSE =>
                Put_FloorTh(accom.floor_count); -- 0 means: put no spaces before the number
                Put(" storey house at ");
