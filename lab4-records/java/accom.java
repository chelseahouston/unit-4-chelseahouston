...
public class acc
{
    ...
    static class House extends Accommodation
    {
    ...
    static class Flat extends Accommodation
    {        
        private String street;
        ...
        public Flat(String street, int flatNumber, int floor)
        {
            this.street = street;
        ...
        {
            String result = "";
            result += floorToTh(getFloor());
            result += " floor flat at ";
            result += getFlatNumber();
            result += " ";
            result += getStreet();
